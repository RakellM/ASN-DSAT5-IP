...
# Create a program that displays the following chocolate cake recipe.
# Display one item at a time, as the person presses "enter".

print("\nIngredientes:")
input(" ▪️ 2 xícaras de farinha de trigo")
input(" ▪️ 1 xícara de açúcar")
input(" ▪️ 1/2 xícara de cacau em pó")
input(" ▪️ 1 colher de chá de fermento em pó")
input(" ▪️ 1 colher de chá de bicarbonato de sódio")
input(" ▪️ 1/2 colher de chá de sal")
input(" ▪️ 2 ovos")
input(" ▪️ 1 xícara de leite")
input(" ▪️ 1/2 xícara de óleo vegetal")
input(" ▪️ 2 colheres de chá de extrato de baunilha")
input(" ▪️ 1 xícara de água fervente")
